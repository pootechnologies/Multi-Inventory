...
# ALLOWED_HOSTS = []
ALLOWED_HOSTS = ["*.dev-inventory-api.pootechnologies.tech", ".dev-inventory-api.pootechnologies.tech", "dev-inventory-api.pootechnologies.tech", "45.93.136.48"]
...
BASE_DOMAIN = "dev-inventory-api.pootechnologies.tech"
...
EMAIL_VERIFICATION_URL = 'https://dev-inventory-api.pootechnologies.tech/tenants/email/verify/'
# Frontend password reset page
FRONTEND_PASSWORD_RESET_URL = 'https://dev-inventory.pootechnologies.tech/password/reset'
FRONTEND_LOGIN_URL = 'https://dev-inventory.pootechnologies.tech/login'
