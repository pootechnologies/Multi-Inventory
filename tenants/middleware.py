...
class TenantPaymentRequiredMiddleware:
    ...
    def __call__(self, request):
        ...
        if tenant and tenant.schema_name != "public":
            ...
            if tenant.on_trial and tenant.paid_until and tenant.paid_until <= current:
            ...
            if tenant.paid_until and tenant.paid_until >= current:
                return self.get_response(request)

            if tenant.grace_until and tenant.grace_until >= current:
                return self.get_response(request)
